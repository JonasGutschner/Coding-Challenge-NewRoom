...
exports.UserInterfaceComponent = void 0;
...
exports.UserInterfaceComponent = (() => {
    ...
    let _classThis;
    var UserInterfaceComponent = _classThis = class {
        constructor(http) {
            this.http = http;
        }
        SendData() {
    ...
    __setFunctionName(_classThis, "UserInterfaceComponent");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        UserInterfaceComponent = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserInterfaceComponent = _classThis;
})();
